...
vcf <- readVcf("E://fan_lab//Kidney//SV_calling//Gridss//svtype_annotation//DDN21014557_gridss_25.vcf.gz", "hg38")
...
writeVcf(vcf, "DDN21014557.annotated.vcf") # generated by example/gridss.sh
...
write.table(simplebed, "DDN21014557.simple.bed", quote=FALSE, sep='\t', row.names=FALSE, col.names=FALSE)
